      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            db = _context2.sent;
            _context2.next = 6;
            return db.query("SELECT idUsers FROM users WHERE nameUser = ?;", [req.body.nameUser, req.body.passwordUser]);
          ...
          case 6:
            ...
            _context2.next = 13;
            return db.query("SELECT * FROM users WHERE idUsers = ?", [rows.idUsers]);
